...
coin2=pygame.transform.smoothscale(pygame.image.load('coin2.png'),(100,100))
def coin(x, y):
...
def main():
    ...
    coinX2, coinY2 = random.randint(0, 352), 0
    coin_speed = 2.5
    ...
    while not collision(playerX, enemyX, playerY, enemyY):
        ...
        if coinY2 >= 600:
            coinY2 = 0
            coinX2 = random.randint(0, 352)     
        if collision(playerX, coinX, playerY, coinY):
            score += 1
            coinY = 0
            coinX = random.randint(0, 352)
        if collision(playerX, coinX2, playerY, coinY2):
            score += 3
            coinY2 = 0
            coinX2= random.randint(0, 352)    
